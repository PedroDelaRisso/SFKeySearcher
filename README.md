...
A quick project done using Vite, Deno, TypeScript, Axios, React and Tailwindcsss. This app consumes the reddit API to search for comments on the [subreddit r/SoulFrame code sharing megathread](https://reddit.com/r/SoulFrame/comments/1ih1iit/?sort=new) and prints them on screen if they contain SoulFrame keys.
